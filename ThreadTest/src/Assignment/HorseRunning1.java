...
//		List<Integer> Running = new ArrayList<>();
		HorseList.add(new Horse1("0번마",1,0));
		HorseList.add(new Horse1("1번마",1,0));
		HorseList.add(new Horse1("2번마",1,0));
		HorseList.add(new Horse1("3번마",1,0));
		HorseList.add(new Horse1("4번마",1,0));
		HorseList.add(new Horse1("5번마",1,0));
		HorseList.add(new Horse1("6번마",1,0));
		HorseList.add(new Horse1("7번마",1,0));
		HorseList.add(new Horse1("8번마",1,0));
		HorseList.add(new Horse1("9번마",1,0));
...
class Horse1  extends Thread implements Comparable<Horse1>{
	...
	private int where;
	// 생성자
	public Horse1(String nm, int rank, int where) {
		this.nm = nm;
		this.rank = rank;
		this.where = where;
	}
