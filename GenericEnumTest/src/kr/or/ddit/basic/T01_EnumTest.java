 ...
 * 
 * 열거형 선언하는 방법
 * enum 열거형 이름 {상수값1, 상수값2, ...., 상숫값n};
 */
	//City 열거형 객체 선언(기본값을 이용하는 열거형) - 1.타입안전한코드를 작성할 수 있다.★
	...
	//생성자 만들기 (열거형의 생서자는 제어자가 묵시적으로 'private'이다)
	...
	public static void main(String[] args) {
		...
		System.out.println(city.equals(City.대구));
		System.out.println(city ==City.대구);
		System.out.println(city.equals("대구"));
		
		System.out.println("대구=> " + city.compareTo(City.대구));
		System.out.println("서울=> " + city.compareTo(City.서울));//ordinal.대구=2, ordinal.서울=0, 대구-서울 =2
