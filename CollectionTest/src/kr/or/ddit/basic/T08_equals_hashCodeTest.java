...
public class T08_equals_hashCodeTest {
	 ...
	 * 해시함수에 의해 얻어지는 값은 해시 값, 해시 코드 , 해시 체크섬 또는 간단하게 해시라고 한다.
	 ...
	 *  5. hashCode()는 기본적으로 Heap에 있는 각 객체에 대한 메모리 주소 매핑 정보를 기반으로 한
	 *  	정수값을 반환한다. 그러므로, 클래스에서 hashCode()메서드를 override하지 않으면 
	 ...
	 */
		public static void main(String[] args) {
			...
			System.out.println("revome(p2) 성공여부 : " + set.remove(p3));
